    ...
    <div class="container-fluid" style="padding-top: 3rem !important;">
            ...
            <div class="container col-md-10 " id="main">
                ...
                <div class="container text-center py-2">
                    <h1 class="display-4 mb-2">Carga masiva de Autoridades</h1>
                </div>
                ...
                ?>
                    ...
                    <div class="container text-center ">
                        <form class="<?php echo (isset($class_form)) ? $class_form : 'vh-100'; ?>" action="php/valida_carga_autoridad.php" enctype="multipart/form-data"  method="post">
                            <div class="custom-file">
                                ...
                                <a type="submit" class="btn btn-dark text-white"  href="formatos/Autoridades_carga_masiva.xlsx" download="Formato.xlsx">Descarga formato de carga masiva de Autoridades.</a> 
                            </div>
                             ...
                             if (isset($_GET["resultado"])) {
                                 switch ($_GET["resultado"]) {
                                   case 1:
                                    ...
                                    $contribuyentes->Leer_archivo_Autoridad();
                                   break;
                                }
                             }
    ...
    <div class="modal fade" id="resultado_carga" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="renovar()" data-dismiss="modal">Aceptar</button>
            </div>
            </div>
        </div>
    </div>
