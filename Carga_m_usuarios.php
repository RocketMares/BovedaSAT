    ...
    <div class="container-fluid" style="padding-top: 3rem !important;">
            ...
            <div class="container col-md-10 " id="main">
                ...
                <div class="container text-center py-2">
                    <h1 class="display-4 mb-2">Carga masiva de Usuarios</h1>
                </div>
                    ...
                    <div class="container text-center ">
                        <form class="<?php echo (isset($class_form)) ? $class_form : 'vh-100'; ?>" action="php/valida_carga_usuarios.php" enctype="multipart/form-data"  method="post">
                            <div class="custom-file">
                                ...
                                <a type="submit" class="btn btn-dark text-white"  href="formatos/Carga_M_Empleados.xlsx" download="Formato.xlsx">Descarga formato de carga masiva de empleados.</a> 
                            </div>
