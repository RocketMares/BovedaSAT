...
{	
    ...
    switch ($_GET) {
        case isset($_GET['id_tiket_integra']):
				...
				$this->Text(140, 36, utf8_decode('TICKET DE INTEGRACIÓN'));
				date_default_timezone_set('America/Mexico_City');
				$diassemana = array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sábado");
				$meses = array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
				$Fecha_hoy=date('d')." de ".$meses[date('n')-1]. " del ".date('Y');
				$this->Code39(20,10,$tiket,1,10);/////////////////////////////CREA CODIGO BARRAS
				$this->Image('../img/logo.png', 240, 5, 90, 17);
				$this->SetFont('Arial', '', 10);
				$this->Text(240, 32, utf8_decode('Administración Desconcentrada de Recaudación'));
				$this->Text(240, 36, utf8_decode($admin_gen));
				$this->Text(240, 40, utf8_decode('Ciudad de México a '.$Fecha_hoy));
        break;
        case isset($_GET['id_tiket']):
                $tiket = $_GET['id_tiket'];
				$datos_GENERAL=$metodos->Datos_de_imprecion2($tiket); 
				$admin_gen = $datos_GENERAL["nombre_admin"];
				$this->SetFont('Arial', 'B', 18);
				$this->Text(135, 36, utf8_decode('TICKET DE PRÉSTAMO'));
				date_default_timezone_set('America/Mexico_City');
				$diassemana = array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sábado");
				$meses = array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
				$Fecha_hoy=date('d')." de ".$meses[date('n')-1]. " del ".date('Y');
...
{	
	...
	$this->Text(38, 200, utf8_decode('_______________________________'));
	$this->Text(40, 205, utf8_decode('FIRMA ENCARGADO DE BÓVEDA'));
	$this->SetFont('Arial', 'B', 12);
	$this->Text(240, 200, utf8_decode('_______________________________'));
